...
class GameSession
{
    public void Start()
    {
        ...
        Army attacker = new(1, FactionName.France, UnitType.Cavalry, 750);
        Army defender = new(2, FactionName.England, UnitType.Infantry, 1000);
        ...
        Army attacker2 = new(3, FactionName.France, UnitType.Cavalry, 750);
        Army defender2 = new(4, FactionName.England, UnitType.Infantry, 1000);
